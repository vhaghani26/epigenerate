...
Although you should generally limit usage to 32 CPUs, if you have some kind of a rush job, you can use most of them if you `nice` your jobs to reduce their priority. In fact, if you want to be a good lab citizen, you will `nice` all of your jobs (e.g. `nice {your_command}`). To `nice` your job, simply put precede your command with the word `nice`. As a general rule of thumb, `nice` your job if you expect it to run for over 24 hours. If nobody else is using epigenerate at the time, this still gives you the full allocation of resources you are running your program with.
